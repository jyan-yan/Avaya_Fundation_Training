...
- HTML format: `<img src="img/1-1-roles.png" alt="roles" width="600">` 
- Markdown format:`![alt text](img/image.png)`

Save images in ./img/ directory. All pictures in this directory need to be pushed to github repository as well.

## How to configure the picture rule in Typora

![image-20260714070020783](./img/image-20260714070020783.png)
